...
{// GDO0:达到或超出RX_FIFO阈值 填充RX_FIFO时置位,或到达数据包结尾时置位
...
* Description    : This function handles TIM1 overStatusStr.FlowValue and update interrupt 
*                  request.
* Input          : None
* Output         : None
* Return         : None
...
{
	// GDO2:发送/接收到同步字时置位,并在数据包的末尾取消置位
